...
<div id="id_container" class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active" href="techzone.php"><span class="sr-only">(current)</span>TechZone</a>
	...
	<div class="row" >
        <div class="col text-center">
            <span style="font-size:35px">TechZone</span>
        </div>
    </div>
    <div class="row">
        <div class="col">
        <div id="rightcol">
         ...
         <div class="references">
            ...
            <p>Netcraft, 2014a. November 2014 Web Server Survey | Netcraft.  News.netcraft.com. 
               Available at: &lt;http://news.netcraft.com/archives/2014/11/19/november-2014-web-server-survey.html#more-17712&gt; 
